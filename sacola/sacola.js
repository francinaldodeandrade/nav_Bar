class Pedido { 
    ...
    listarProdutos () {
        ...
        let listaItem = document.querySelector("#listagem") //guardei o valor digitado no input na variavel listaItem
        ...
        this.itens.map( item => {
            ...
            let listagem = document.createElement("p")  //criei o elemento h5 no html
...
function enviar() {
    ...
    /*if (operation === cad.value && input1.value != "" && input2.value != "" ) {*/
        ...
        carrinho.adicionarProduto(prod.value) /*, input2.value.trim(), input3.value.trim())*/
